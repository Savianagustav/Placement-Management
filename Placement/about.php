		...
		<!--banner-section-->
            ...
            <div class="top-news">
                <div class="about-content">
                    ...
                    <img src="image_uploads/KJC_logo.jpg" alt="" />
                ...
                <div class="edit-pics">
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">IT SOURCECODE TEAM</a></h5>
                    ...
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">TEAM WASLIK</a></h5>
                            <div class="td-post-date two"></div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="editor-pics">
                        ...
                        <div class="col-md-9 item-details">
                            <h5 class="inner two"><a href="single.html">TEAM PALAHUBOG</a></h5>
                            <div class="td-post-date two"> </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
