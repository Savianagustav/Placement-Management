	...
	<div class="login">
		<div class="login-grids">
            ...
            <div class="col-md-6 login-right">
                <h3 class="tittle">New here register with us <i class="glyphicon glyphicon-file"></i></h3>
                <p>By creating an account, you will be able to move through the recruitment process faster,
